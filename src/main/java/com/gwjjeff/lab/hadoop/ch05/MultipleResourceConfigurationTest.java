package com.gwjjeff.lab.hadoop.ch05;
...
public class MultipleResourceConfigurationTest {
  ...
  public void get() throws IOException {
    ...
    conf.addResource("com/gwjjeff/lab/hadoop/ch05/configuration-1.xml");
    conf.addResource("com/gwjjeff/lab/hadoop/ch05/configuration-2.xml");
    // ^^ MultipleResourceConfigurationTest
